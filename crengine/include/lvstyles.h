...
enum css_style_rec_important_bit {
    ...
    imp_bit_content,
    imp_bit_initial_letter_size,
    imp_bit_initial_letter_sink,
    imp_bit_cr_hint
};
...
struct css_style_rec_tag {
    ...
    lString32              content;
    lInt16                 initial_letter_size;
    lInt16                 initial_letter_sink;
    ...
    css_style_rec_t *    pseudo_elem_first_letter_style;
